...
def eval_sample(item, eval_fn, model):
    """
    This function allows us to evaluate if an answer to a question
    in the prompt is a good answer.
...
def run_validation_revert(
    system_prompt: tg.Variable, results, model, eval_fn, val_set
):
...
print(
    "Train/Val/Test Set Lengths: ", len(train_set), len(val_set), len(test_set)
)
